...
async function startTempDatabase() {
  ...
  const adminConnectionString = `postgres://creator:creator@127.0.0.1:${port}/postgres`;
  await ensurePostgresDatabase(adminConnectionString, "creator");
  const connectionString = `postgres://creator:creator@127.0.0.1:${port}/creator`;
